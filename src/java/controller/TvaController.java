...
public class TvaController implements Serializable {
    ...
    @EJB
    private service.TvaFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("TvaCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("TvaUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("TvaDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public List<Tva> getItemsAvailableSelectMany() {
        return getFacade().findAll();
    }

    public List<Tva> getItemsAvailableSelectOne() {
        return getFacade().findAll();
    }
